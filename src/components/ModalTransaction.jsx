  ...
  return (
    ...
    >
      ...
      <div className='flex justify-end p-3.5 pb-0 bg-gray-100 rounded'>
        <button className='relative mb-3.5 ml-2.5 mr-1 text-sm bg-red-600 opacity-85 hover:opacity-100 duration-300 transition-opacity text-white py-2.5 pr-15 pl-5.5 rounded cursor-pointer'>
